...
install.packages('hgu133plus2hsentrezgcdf_22.0.0.tar.gz', repos=NULL, type='source')
install.packages('hgu133ahsentrezgcdf_22.0.0.tar.gz', repos=NULL, type='source')